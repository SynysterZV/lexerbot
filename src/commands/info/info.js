  ...
  async execute(message, args) {
    ...
    const embed = new (require("discord.js").MessageEmbed)()
      ...
      .addFields(
        {
          name: "**Discord Data**",
          value: `•Guilds: \`${message.client.guilds.cache.size}\`\n•Channels: \`${message.client.channels.cache.size}\`\n•Users: \`${userCount}\``,
        },
        {
          name: "Usage Stats",
          value: `•CPU Usage: \`${Math.round(
            cpu
        ...
        },
        {
          ...
          value: new Date(CA.createdTimestamp).toDateString(),
        },
        {
          name: "**Uptime:**",
          value: `${Math.ceil(message.client.uptime / (1000 * 60))} minutes`,
        }
      )
