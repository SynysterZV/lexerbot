...
module.exports = {
    ...
    async execute(message, args) {
        ...
        if(isNaN(days) || days < 0 || days > 7) return message.reply('Days needs to be a valid number between 1 - 7')
        ...
        return message.reply(`Successfully banned **${member.user.tag}** for **${time}** because **${reason}**`)
    }
}